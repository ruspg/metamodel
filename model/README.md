...
- [`profiles/`](profiles/) — фильтры профильных проекций (например, `atlas_mvp.yaml`).
- [`templates/`](templates/) — готовые шаблоны для контрибьюторов, добавляющих новые сущности или связи.
- [`schema/`](schema/) — JSON Schema контракты валидации.
- [`glossary/`](glossary/) — термины глоссария, алиасы и артефакты политики именования.
